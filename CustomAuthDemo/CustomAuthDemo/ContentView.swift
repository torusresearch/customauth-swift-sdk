...
struct ContentView: View {
    ...
    var body: some View {
        VStack {
            ...
            /*
            Button(action: {
                let sub = SubVerifierDetails(typeOfLogin: .apple,
                                             verifier: "torus-auth0-apple-lrc", clientId: "m1Q0gvDfOyZsJCZ3cucSQEe9XMvl9d9L",
                                             redirectURL: "tdsdk://tdsdk/oauthCallback", jwtParams: Auth0ClientOptions(domain: "torus-test.auth0.com"))
                let customAuthArgs = CustomAuthArgs(urlScheme: "tdsdk://tdsdk/oauthCallback", network: .legacy(.TESTNET), enableOneKey: true, web3AuthClientId: "BPi5PB_UiIZ-cPz1GtV5i1I2iOSOHuimiXBI0e-Oe_u6X3oVAbCiAZOTEBtTXw4tsluTITPqA8zMsfxIKMjiqNQ")
                Task {
                    do {
                        let customAuth = try CustomAuth(config: customAuthArgs)
            ...
            */
            ...
            Button(action: {
                let sub = SubVerifierDetails(typeOfLogin: .jwt,
                                             verifier: "web3auth-custom-jwt", clientId: "m1Q0gvDfOyZsJCZ3cucSQEe9XMvl9d9L",
                                             redirectURL: "tdsdk://tdsdk/oauthCallback", jwtParams: Auth0ClientOptions(domain: "web3auth.io", verifierIdField: "email"))
                let customAuthArgs = CustomAuthArgs(urlScheme: "tdsdk://tdsdk/oauthCallback", network: .legacy(.TESTNET), enableOneKey: true, web3AuthClientId: "BPi5PB_UiIZ-cPz1GtV5i1I2iOSOHuimiXBI0e-Oe_u6X3oVAbCiAZOTEBtTXw4tsluTITPqA8zMsfxIKMjiqNQ")
                Task {
                    do {
                        let customAuth = try CustomAuth(config: customAuthArgs)
