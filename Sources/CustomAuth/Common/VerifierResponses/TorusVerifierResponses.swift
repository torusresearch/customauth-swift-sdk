...
public class TorusVerifierResponse: Codable {
    ...
    public init(email: String, name: String, profileImage: String, aggregateVerifier: String? = nil, verifier: String, verifierId: String, typeOfLogin: LoginType, ref: String? = nil) {
                //, extraVerifierParams: PassKeyExtraParams? = nil) {
        self.email = email
        self.name = name
