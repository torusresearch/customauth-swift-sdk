                ...
                Section(header: Text("Single Logins")) {
                    Group{
                        ...
                        Button(action: {
                            ...
                            tdsdk.triggerLogin(controller:vc,browserType: .sfsafari, modalPresentationStyle: .fullScreen).done{ data in
...
//                            tdsdk.triggerLogin(browserType: .external, modalPresentationStyle: <#modalPresentationStyle#>).done{ data in
//                                print("private key rebuild", data)
//                            }.catch{ err in
//                                print(err)
//                            }
...
//                        tdsdk.triggerLogin(browserType: .sfsafari, modalPresentationStyle: .fullScreen).done{ data in
//                            print("private key rebuild", data)
//                        }.catch{ err in
//                            print(err)
//                        }
